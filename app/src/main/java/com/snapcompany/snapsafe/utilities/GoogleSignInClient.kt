...
class GoogleSignInClient(private val context: Context) {
    ...
    suspend fun signIn(): Boolean {
        ...
        try {
            val credentialRequest = buildCredentialRequest()
            return handleSignIn(credentialRequest)
    ...
    private suspend fun handleSignIn(result: GetCredentialResponse): Boolean {
        ...
        if(credential is CustomCredential && credential.type == GoogleIdTokenCredential.TYPE_GOOGLE_ID_TOKEN_CREDENTIAL){
            ...
            try {
                ...
                println(tag + "profileImage: ${tokenCredential.profilePictureUri}")
                println(tag + "phone: ${tokenCredential.phoneNumber}")

                name = tokenCredential.displayName
                email = tokenCredential.id
                profileImageUrl = tokenCredential.profilePictureUri
            ...
            println(tag + "Credential type not GoogleIdTokenCredential")
            return false
        ...
        val request = GetCredentialRequest.Builder()
            .addCredentialOption(
                GetGoogleIdOption.Builder()
                    ...
                    .setServerClientId("19080178716-3pljgb4ra7s08mrookdfdmh02tgc127l.apps.googleusercontent.com")
